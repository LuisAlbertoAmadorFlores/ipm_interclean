<div>
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class=" input-group mb-3">
                <label for="nameinput"
                    class="input-group-text bg-dark border-0 text-light col-lg-5 d-flex justify-content-end"
                    style="background-color: rgba(32, 96, 164, 0.767);">ID de Colaborador</label>
                <input type="text" class="form-control " 
                    placeholder="ID" wire:model="colaborador" required>
            </div>
            <div>
                @error('tipo')
                    <span class="error text-warning text-center">{{ $message }}</span>
        ...
        <div class="col-lg-6">
            <div class="input-group mb-3 ">
                ...
                <input type="file" class="form-control" name="Documento" accept=".pdf,image/*" wire:model="evidencia"
                    required>
            </div>
        </div>
    </div>
    ...
    <div class=" mb-3">
        <label for="nameinput" class="input-group-text bg-dark border-0 text-light"
            style="background-color: rgba(32, 96, 164, 0.767);">Descripcion</label>
    ...
    <div class="d-flex justify-content-between">
        ...
        <div wire:loading.remove>
            ...
            <button type="button" class="btn btn-primary" wire:click="saveIncidencia({{ Auth::user()->id }})"
