...
<body>
    <div id="app">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @guest
                            @if (Route::has('login'))
                                <li class="nav-item">
                                    <a class="nav-link text-light" href="{{ route('login') }}" style="border-right: solid white 1px;">{{ __('Ingresar') }}</a>
                                </li>
                            @endif
                            ...
                            @if (Route::has('register'))
                                <li class="nav-item ms-5">
                                    <a class="btn btn-primary text-light" href="{{ route('manual') }}"><i
                                            class="fa-solid fa-book"></i> Manual de Uso</a>
                                </li>
                            @endif
                        @else
        ...
        <main class="content loginregister">
            @yield('content')
        </main>
    </div>
</body>
