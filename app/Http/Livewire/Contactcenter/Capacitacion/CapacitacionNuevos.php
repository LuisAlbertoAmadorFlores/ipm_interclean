...
class CapacitacionNuevos extends Component
{
    use WithPagination;
    private $personal;
    ...
    public function render()
    {
        ...
        return view('livewire.contactcenter.capacitacion.capacitacion-nuevos', ['personalNuevo' => $this->personal]);
    }
}
